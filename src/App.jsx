      ...
      >
        ...
        >
          {[
            ...
            {
              icon: Linkedin,
              href: "https://www.linkedin.com/in/sachin-vernekar-2b38ab289",
            },
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              <p className="text-lg leading-relaxed">
                I am a dedicated BCA student with a current academic CGPA of
                9.19, having a strong interest in the IT industry and a passion
                for learning diverse technologies.
              </p>
              <p className="text-lg leading-relaxed">
                I enjoy building projects, learning new tools, and improving my
                technical and problem-solving skills. My goal is to grow as a
                versatile IT professional who can adapt, learn quickly, and
...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "landing page for college bus transportation system using react",
      image: budd,
    ...
    },
    {
      ...
      description:
        "website where users can share their innovative ideas and reviews with organisations directly",
      image: mady,
